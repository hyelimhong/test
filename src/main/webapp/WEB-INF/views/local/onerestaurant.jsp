...
<!-- 상세페이지 내용-->
 ...
 <div class="local-row" >
               <!-- Post content-->
                    <article>
                        ...
                        <header class="mb-4" id="article" style="text-align: center; padding-top: 60px;">
                            <!-- Post title-->
                            <h1 class="fw-bolder mb-1" style="font-weight: 700; font-size:80px;">${one2.name}</h1>
                            <!-- Post meta content-->
                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade" style=" margin-bottom: 30px;">
  							<div class="carousel-inner">
    							<div class="carousel-item active">
     								<img style="width:500px; height:700px; border-radius: 0.25rem !important;" src="../resources/img/${one2.img}" class="d-block w-100" alt="...">
    							</div>
    							<div class="carousel-item">
      								<img style="width:500px; height:700px; border-radius: 0.25rem !important;" src="../resources/img/${one2.img2}" class="d-block w-100" alt="...">
    							</div>
    							<div class="carousel-item">
      								<img style="width:500px; height:700px; border-radius: 0.25rem !important;" src="../resources/img/${one2.img3}" class="d-block w-100" alt="...">
    							</div>
  							</div>
  ...
  border-spacing: 0 20px;">
   ...
   <!-- 연관 추천 관광지-->
    <div class="card mb-4" style="margin-top: 8rem; height: 400px; width: 400px; ">
